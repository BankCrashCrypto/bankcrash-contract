...
contract BankCrashTokenV3Test is Initializable, ERC20Upgradeable, OwnableUpgradeable, Interest {
    ...
    */
    ...
    /**
    * @notice Initializ ation method which sets the name, symbol of token and mint initial supply to the deployer of contract.
    */
    ...
    */
    ...
    uint256 public constant stakingRewardHalveningStart = 1690725873;
    ...
    */
    function unstake(uint256 _stakeId) external {
        ...
        console.log('getStakePenalty(_stakeId) ->', getStakePenalty(_stakeId));
    ...
    */
    function calculateReward(uint256 finalApy, Stake memory userStake) internal view returns (uint256) {
        ...
        while (periodStart < userStake.endAt) {
            ...
            // if (block.timestamp <= periodEnd) {                
            //     periodDuration = block.timestamp.sub(stakingStart);
            // } else {
            //     periodDuration = halvingPeriod;
            // }
            ...
            // Calculate the reward for this period
